...
import { DATE_FORMATS, END_TIME, START_TIME } from '../../constants';
import { DeletePopupComponent } from '../delete-popup/delete-popup.component';
import { compareTimes, getEventTime } from '../../helpers';
...
export class ModalDialogComponent implements OnInit, AfterViewInit, OnChanges, OnDestroy {
  ...
  constructor(private renderer: Renderer2, private cdr: ChangeDetectorRef, private eventService: AeEventifyService) { }
